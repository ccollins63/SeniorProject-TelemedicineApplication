                ...
                <div class="col-5">
                  <div class="tab-content" id="nav-tabContent" style="max-width: 400px">
                    <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                      ...
                      <p> <span><?php echo "$userFirstName $userLastName"; ?></span><br>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="messagesInput.php" method="post">
                            ...
                            <div class="modal-footer">
                              ...
                              <button type="button" id="save" class="btn btn-primary" data-dismiss="modal">Confirm</button>
                            </div>
                          </div>
                        </div>
                      </div>
...
<script>
  ...
  save.onclick = function(){
      ...
      var text = document.getElementById("replyTextArea").value;
