<?php
    ...
    $sql = "UPDATE User Set (FirstName, LastName, Email, DateOfBirth) VALUES ('$staticFirstName', '$staticLastName', '$staticEmail', '$staticBirth') WHERE PatientID = '$_SESSION[userID]";
